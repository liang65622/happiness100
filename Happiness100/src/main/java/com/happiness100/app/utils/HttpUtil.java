...
public class HttpUtil {
    ...
    public static void main(String[] args) {
        try {
//            System.out.print(get("http:/api.cn.ronghub.com"));

            Map<String,String> maps = new HashMap<String,String>();
            maps.put("userId","12");

            Map<String,String> headers = new HashMap<String,String>();
            headers.put("App-Key","pvxdm17jxxoor");
            headers.put("Nonce","560531778");
            headers.put("Timestamp","1472003795");
            headers.put("Signature","838412777308b2d60db817a4813fbe20d7f6a56f");

           System.out.print(postForm("http://api.cn.ronghub.com/user/getToken.json",maps,headers));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
