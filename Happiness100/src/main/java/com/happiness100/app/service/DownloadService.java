package com.happiness100.app.service;
...
import com.happiness100.app.interf.ICallbackResult;
import com.happiness100.app.ui.activity.MainActivity;
import com.happiness100.app.utils.StringUtils;
import com.happiness100.app.utils.TDevice;
...
public class DownloadService extends Service {
	...
	private String saveFileName = com.happiness100.app.App.DEFAULT_SAVE_FILE_PATH;
...
//							"文件已下载完毕", contentIntent);
	...
	private Runnable mdownApkRunnable = new Runnable() {
		@Override
		public void run() {
			File file = new File(App.DEFAULT_SAVE_FILE_PATH);
			if (!file.exists()) {
				file.mkdirs();
			}
