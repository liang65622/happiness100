...
package com.happiness100.app.ui.widget.wheel;
...
import com.happiness100.app.ui.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xC8C8C8C8,
			0x00C8C8C8, 0x00FFFFFF };
	...
	private void initResourcesIfNecessary() {
		...
		//setBackgroundResource(wheelBackground);
		setBackgroundColor(getResources().getColor(R.color.discover_gray));
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.tm_gray));
		// 设置线宽
	...
	private boolean rebuildItems() {
		...
		firstItem = first;
		updateItemsLayoutItem(currentItem);
		return updated;
	}
	...
	void updateItemsLayoutItem(int index)
	{
		if (itemsLayout != null && itemsLayout.getChildCount() > 0)
		{
			for (int i = 0; i < itemsLayout.getChildCount();++i)
			{
				...
				int indx = (int)view.getTag();
				if (indx == index)
				{
					view.setTextColor(getResources().getColor(R.color.wheel_blue));
				}
				else
				{
