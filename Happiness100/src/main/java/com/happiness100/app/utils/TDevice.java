...
public class TDevice {
    ...
    public static String getUdid() {
        ...
        if (udid.length() == 0) {
            SharedPreferences.Editor editor = App.getPreferences()
                    .edit();
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & App.context().getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = App.context()
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean isZhCN() {
        String lang = App.context().getResources()
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            ToastUtils.shortToast(context,"你手机中没有安装应用市场！");
            return;
        }
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_VIEW);
    ...
    public static int getVersionCode() {
        ...
        try {
            versionCode = App
                    .context()
                    .getPackageManager()
                    .getPackageInfo(App.context().getPackageName(),
                            0).versionCode;
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) App.context()
    ...
    public static void openApp(Context context, String packageName) {
        ...
        if (mainIntent == null) {
            ...
            Log.e(TAG,"Action:" + mainIntent.getAction());
        }
