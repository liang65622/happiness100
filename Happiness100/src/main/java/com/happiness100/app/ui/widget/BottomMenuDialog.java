...
public class BottomMenuDialog extends Dialog implements View.OnClickListener {
    ...
    public BottomMenuDialog(Context context,int num, String text1, String text2, String text3) {
        super(context, R.style.dialogFullscreen);

        this.num = num;
        this.confirmText = text3;
        this.middleText = text2;
        this.cancelText = text1;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localPhotosBtn.setVisibility(View.GONE);
        photographBtn.setVisibility(View.GONE);
        if(num >0)
            cancelBtn.setVisibility(View.VISIBLE);
        if (num >1)
            localPhotosBtn.setVisibility(View.VISIBLE);
        if(num > 2)
